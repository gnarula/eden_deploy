...
# Script to turn a generic Debian Wheezy box into an Eden server
...
function ConfigManagementScript {
    #####################
    # Management scripts
    #####################
...
su -c - postgres "psql -q -d sahana -f /usr/share/postgresql/9.3/extension/postgis--2.1.1.sql"
